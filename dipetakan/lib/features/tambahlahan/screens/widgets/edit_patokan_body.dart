...
class EditPatokanBody extends StatefulWidget {
  const EditPatokanBody({super.key});

  @override
  State<EditPatokanBody> createState() => _EditPatokanBodyState();
}

class _EditPatokanBodyState extends State<EditPatokanBody> {
  File? imageFile;
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              SizedBox(
                width: double.infinity,
                child: OutlinedButton(
                    onPressed: () {}, child: const Text(DTexts.hapusPatokan)),
              ),
            ],
          ),
        ),
